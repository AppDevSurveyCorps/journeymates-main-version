        ...
        <nav class="bg-white px-2 sm:px-4 py-4 mx-12">
            <div class="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <div class="hidden w-full md:block md:w-auto" id="mobile-menu">
                    <ul
                        class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium items-center">
                        <li>
                        ...
                        <li>
                            <div class="relative">
                                ...
                                <img onclick="dropdown()"
                                    class="h-12 w-12 dropbtn cursor-pointer rounded-full object-cover"
                                    src="https://i.pinimg.com/474x/64/b2/95/64b295c8c9df6a71bb8e72adcb1bb6cd.jpg"
                                    alt="">
                                <!-- Dropdown list -->
                                <div id="myDropdown"
                                    class="absolute right-0 py-2 mt-2 bg-white bg-gray-100 rounded-md shadow-xl w-44 dropdown-content hidden z-50">
                                    <h1 class="block px-4 py-2 text-lg text-gray-300 text-gray-700">Hi,
                                        {{ucwords(auth()->user()->fname)}}</h1>
                                    <hr>
                                    <a href="{{ url('profile') }}"
