  ...
  <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
	...
	<div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
		...
		<div class="p-4 md:p-12 text-center lg:text-left">
			...
			<h1 class="text-3xl font-bold pt-8 lg:pt-0">{{$place->place_name}}</h1>
			<div class="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-green-500 opacity-25"></div>
			<p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start"><i class="far fa-eye"></i> &nbsp; Total Viewers: {{ $place->page_viewer_count }}</p>
			<p class="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start"><i class="far fa-clock"></i> &nbsp; Last Updated at: {{ $place->updated_at }}</p>
			<p class="pt-8 text-sm">{{$place->place_description}}</p>

			<div class="pt-12 pb-8">
			<form class="form-horizontal poststars" action="/places" id="addStar" method="POST">
			{{ csrf_field() }}
	...
	<div class="w-full lg:w-2/5">
		...
		<img src="{{ asset('storage/images/' . $place->place_image) }}" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
