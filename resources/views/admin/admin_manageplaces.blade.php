                ...
                <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
                    ...
                    <nav class="flex flex-col mt-10 px-4 text-center">
                        ...
                        <a href="{{ url('manage_user') }}"
                            class="mt-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-800 rounded">Manage
                            users</a>
                                ...
                                <div class=" flex items-center justify-between pb-6">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex bg-gray-50 items-center p-2 rounded-md">
                                            ...
                                            <a href='/add_place' class="w-full py-3 mt-6 font-medium tracking-widest text-white uppercase bg-black shadow-lg focus:outline-none hover:bg-gray-900 hover:shadow-none">
                                                Create new place
                                            </a>
                                        </div>
                                            ...
                                            <table class="min-w-full leading-normal">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="px-5 py-5 bg-white text-sm">
                                                            <p class="text-gray-900 whitespace-no-wrap">{{ $p->place_description }}</p>
                                                        </td>
                                                        <td class="px-5 py-5 bg-white text-sm">
